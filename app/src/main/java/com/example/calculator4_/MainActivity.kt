...
import com.example.calculator4_.ui.theme.Calculator4_Theme
...
fun MainScreen(modifier: Modifier = Modifier) {
    ...
    Scaffold(
        ...
        when (selectedTab) {
            ...
            Tab.CALCULATOR_3 -> Calculator3Screen(modifier = Modifier.padding(innerPadding))
        }
    }
}
